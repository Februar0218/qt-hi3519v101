...
void QProxyFontEngine::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData QProxyFontEngine::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QProxyFontEngine::staticMetaObject = {
    { &QFontEngine::staticMetaObject, qt_meta_stringdata_QProxyFontEngine,
      qt_meta_data_QProxyFontEngine, &staticMetaObjectExtraData }
};
