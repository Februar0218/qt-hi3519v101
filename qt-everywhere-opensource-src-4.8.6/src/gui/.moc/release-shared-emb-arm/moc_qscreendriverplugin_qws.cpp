...
void QScreenDriverPlugin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData QScreenDriverPlugin::staticMetaObjectExtraData = {
...
const QMetaObject QScreenDriverPlugin::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QScreenDriverPlugin,
      qt_meta_data_QScreenDriverPlugin, &staticMetaObjectExtraData }
};
